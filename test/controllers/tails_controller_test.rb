...
class TailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tail" do
    assert_difference('Tail.count') do
      post tails_url, params: { tail: { description: @tail.description, user_id: @tail.user_id } }
    end
  ...
  test "should update tail" do
    patch tail_url(@tail), params: { tail: { description: @tail.description, user_id: @tail.user_id } }
